...
import controller_reconstruction
import argparse
import os
...
parser.add_argument("--is_fine_model", action="store_true", help="whether test as fine model")
parser.add_argument("--is_medium_model", action="store_true", help="whether test as medium model")
...
parser.add_argument("--load_medium_ckpt", type=str, help="path to checkpoints directory for fine model")
parser.add_argument("--load_resnet_ckpt", type=str, help="path to checkpoints directory for resnet model")
parser.add_argument("--load_perception_ckpt", type=str, help="path to checkpoints directory for identity perception model")
...
if __name__ == '__main__':
    ...
    if args.mode == 'test':
        controller_reconstruction.reconstruction(args)
